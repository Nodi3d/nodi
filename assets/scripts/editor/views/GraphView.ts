...
import { NodeConnectEventArg, NodeEventArg } from '../../core/misc/Events';
...
export default class GraphView extends View {
  ...
  protected addGroupView (group: Group): GroupView {
  ...
  protected removeGroupView (group: Group): boolean {
